...
public class porta : MonoBehaviour
{
    ...
    public int _itensParaAbrir; // Pode ser usado para verificar inventário ou condição
    ...
    public AudioClip _somTrancada; // 🔊 NOVO: Som de porta trancada
    ...
    {
        // Verifica se precisa destrancar e ainda não destrancou
        if (_temDestrancar && !_jaDestrancou)
        {
            // Verifica se o player tem os itens necessários
        ...
        // Porta está fechada e pode abrir
        ...
        // Porta está aberta e pode fechar
    ...
    IEnumerator DestrancarEPermitirAbrir()
    {
        ...
        AcionarPorta(); // Tenta abrir a porta após destrancar
    }
}